...
function (_React$Component) {
  ...
  function PublishDetails(props) {
    ...
    _this = _possibleConstructorReturn(this, (PublishDetails.__proto__ || Object.getPrototypeOf(PublishDetails)).call(this, props));
    _this.onPublishSubmit = _this.onPublishSubmit.bind(_assertThisInitialized(_this));
    return _this;
  }
