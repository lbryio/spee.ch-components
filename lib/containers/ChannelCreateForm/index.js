...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onNameInput: function onNameInput(value) {
      if (!value) {
        dispatch((0, _channelCreate.updateChannelCreateName)('error', 'Please enter a channel name'));
      } else {
    ...
    onPasswordInput: function onPasswordInput(value) {
      if (!value) {
        dispatch((0, _channelCreate.updateChannelCreatePassword)('error', 'Please enter a password'));
      } else {
