...
function (_React$Component) {
  ...
  function ProgressBar(props) {
    ...
    _this = _possibleConstructorReturn(this, (ProgressBar.__proto__ || Object.getPrototypeOf(ProgressBar)).call(this, props));
    _this.state = {
      bars: [],
      index: 0,
      incrementer: 1
    };
    _this.createBars = _this.createBars.bind(_assertThisInitialized(_this));
    _this.startProgressBar = _this.startProgressBar.bind(_assertThisInitialized(_this));
    _this.updateProgressBar = _this.updateProgressBar.bind(_assertThisInitialized(_this));
    _this.stopProgressBar = _this.stopProgressBar.bind(_assertThisInitialized(_this));
    return _this;
  }
