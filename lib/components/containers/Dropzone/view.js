...
function (_React$Component) {
  ...
  function Dropzone(props) {
    ...
    _this = _possibleConstructorReturn(this, (Dropzone.__proto__ || Object.getPrototypeOf(Dropzone)).call(this, props));
    _this.state = {
      dragOver: false,
      mouseOver: false,
      dimPreview: false
    ...
    _this.chooseFile = _this.chooseFile.bind(_assertThisInitialized(_this));
    return _this;
  }
